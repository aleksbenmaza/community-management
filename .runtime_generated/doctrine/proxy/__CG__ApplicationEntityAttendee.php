 ...
 */
class Attendee extends \Application\Entity\Attendee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Attendee' . "\0" . 'meetings'];
        }
     ...
     * {@inheritDoc}
     */
    public function getMeetings(): \Doctrine\Common\Collections\ArrayCollection
    {
     ...
     * {@inheritDoc}
     */
    public function addMeeting(\Application\Entity\Meeting $meeting): bool
    {
